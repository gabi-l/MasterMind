...
class FeedbackGeneratorTest(TestCase):
    ...
    def test_four_black(self):
        ...
        """
        feedback = FeedbackGenerator.GenerateFeedback(Attempt(CodePeg.Green, CodePeg.Blue, CodePeg.Red, CodePeg.Green))
    ...
    def test_three_black(self):
        ...
        Test an attempt with 4 black pegs as a feedback
        """
        feedback = FeedbackGenerator.GenerateFeedback(Attempt(CodePeg.Green, CodePeg.Blue, CodePeg.Red, CodePeg.Black))
    ...
    def test_two_black_two_white(self):
        ...
        """
        feedback = FeedbackGenerator.GenerateFeedback(Attempt(CodePeg.Green, CodePeg.Blue, CodePeg.Green, CodePeg.Red))
    ...
    def test_two_black_one_white(self):
        ...
        """
        feedback = FeedbackGenerator.GenerateFeedback(Attempt(CodePeg.Green, CodePeg.Blue, CodePeg.Black, CodePeg.Red))
    ...
    def test_two_black(self):
        ...
        """
        feedback = FeedbackGenerator.GenerateFeedback(Attempt(CodePeg.Green, CodePeg.Blue, CodePeg.Black, CodePeg.Black))
    ...
    def test_one_black_three_white(self):
        ...
        """
        feedback = FeedbackGenerator.GenerateFeedback(Attempt(CodePeg.Green, CodePeg.Red, CodePeg.Green, CodePeg.Blue))
    ...
    def test_one_black_two_white(self):
        ...
        """
        feedback = FeedbackGenerator.GenerateFeedback(Attempt(CodePeg.Green, CodePeg.Red, CodePeg.Green, CodePeg.Black))
    ...
    def test_one_black_one_white(self):
        ...
        """
        feedback = FeedbackGenerator.GenerateFeedback(Attempt(CodePeg.Green, CodePeg.Red, CodePeg.Black, CodePeg.Black))
    ...
    def test_one_black(self):
        ...
        """
        feedback = FeedbackGenerator.GenerateFeedback(Attempt(CodePeg.Green, CodePeg.Black, CodePeg.Black, CodePeg.Black))
    ...
    def test_four_white(self):
        ...
        """
        feedback = FeedbackGenerator.GenerateFeedback(Attempt(CodePeg.Blue, CodePeg.Green, CodePeg.Green, CodePeg.Red))
    ...
    def test_three_white(self):
        ...
        """
        feedback = FeedbackGenerator.GenerateFeedback(Attempt(CodePeg.Black, CodePeg.Green, CodePeg.Blue, CodePeg.Red))
    ...
    def test_two_white(self):
        ...
        """
        feedback = FeedbackGenerator.GenerateFeedback(Attempt(CodePeg.Black, CodePeg.Black, CodePeg.Blue, CodePeg.Red))
    ...
    def test_one_white(self):
        ...
        """
        feedback = FeedbackGenerator.GenerateFeedback(Attempt(CodePeg.Black, CodePeg.Black, CodePeg.Black, CodePeg.Red))
    ...
    def test_zero_black_zero_white(self):
        ...
        """
        feedback = FeedbackGenerator.GenerateFeedback(Attempt(CodePeg.Black, CodePeg.Black, CodePeg.Black, CodePeg.Black))
